...
@php $sectionsRenderer = SectionsRenderer::createWithDefaultPaths('scott-clark-cv'); @endphp
...
% (c) 2003-2007 David J. Grant <davidgrant-at-gmail.com> http://www.davidgrant.ca
    ...
    \textbf{\Large <?= $vars->contactInfo->getNameEscaped() ?>}
    ...
    @if($vars->contactInfo->githubUsername)
        & \href{https://github.com/<?= $vars->contactInfo->githubUsername ?>}{github.com/<?= $vars->contactInfo->githubUsername ?>}
    @endif
    \\
    ...
    @if($vars->contactInfo->linkedinUsername)
        & \href{https://www.linkedin.com/in/<?= $vars->contactInfo->linkedinUsername ?>}{linkedin.com/in/<?= $vars->contactInfo->linkedinUsername ?>}
    @endif
      \\
    \end{tabular*}
    \\
