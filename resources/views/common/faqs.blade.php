@php
    ...
    [
        ...
        'answer' => 'We offer a variety of popular LaTeX resume templates, including ' . BladeUtils::linkToTemplate(TemplateType::AWESOME_CV) . ', ' . BladeUtils::linkToTemplate(TemplateType::MCDOWELL_CV) .', ' . BladeUtils::linkToTemplate(TemplateType::DEEDY_RESUME) . ', ' . BladeUtils::linkToTemplate(TemplateType::JAKES_RESUME) . ' and ' . BladeUtils::link('/templates', 'others') . '. We are constantly adding new templates to our collection.'
    ],
    [
